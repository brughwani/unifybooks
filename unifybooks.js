/**
 * Single-file network API for Vercel/Firebase with:
 * - GST-based login (OTP mock)
 * - Items, Accounts, Invoice Requests, Ledger
 * - Network edges
 * - Webhook + FCM notifications to counterparty on invoice creation
 *
 * NOTE: Replace mocks (verifyGST, sendOTP, verifyOTP) with real integrations in prod.
 */
